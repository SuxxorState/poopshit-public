...
class Note extends FlxSprite
{
	...
	public static var swagWidth:Float = (160 * 0.7) * 0.8;
	...
	function loadNoteAnims() {
		...
		setGraphicSize(Std.int((width * 0.7) * 0.8));
		updateHitbox();
	}
	...
	public function followStrumNote(myStrum:StrumNote, fakeCrochet:Float, songSpeed:Float = 1)
	{
		...
		if(copyAlpha && ClientPrefs.data.ibdMode == '')
		...
		if(copyY)
		{
			...
			if (ClientPrefs.data.ibdMode != '' && ((y > 0 && myStrum.downScroll) || (y < 720 && !myStrum.downScroll))) alpha -= 0.025 * songSpeed;
		}
	}
