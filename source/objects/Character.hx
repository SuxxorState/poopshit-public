...
class Character extends FlxSprite
{
	...
	public var dmgOutput:Int = 1; //amount of health lost when missing, reads opponent, not player
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				...
				if (json.dmg_output != null) dmgOutput = json.dmg_output;
